...
def run_test_count_cosines_from():
    ...
    # Test 3:
    expected = 2
    answer = count_cosines_from(5, 10, 0.5)
    print('Test 3 expected:', expected)
    print('       actual:  ', answer)

    # Test 4:
    expected = 5
    answer = count_cosines_from(10, 20, 0.35)
    print('Test 4 expected:', expected)
    print('       actual:  ', answer)

    # Test 5:
    expected = 2
    answer = count_cosines_from(0, 6, 0.75)
    print('Test 5 expected:', expected)
    print('       actual:  ', answer)

    # Test 6:
    expected = 1
    answer = count_cosines_from(7, 9, 0.30)
...
def run_test_sum_unit_fractions_from():
    ...
    # Test 3:
    expected = 2.0199 # This is APPROXIMATELY the correct answer.
